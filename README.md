...
* `CLICKY-GAME` is built with `React.js`. This application is component based and updates to the page render dynamically and without page refresh. used `material-ui` for styling as its a plug-in for react.

* https://gpelleran78.github.io/clicky-game